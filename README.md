...
<!-- PATCHES_START -->
> **[v1.39.3](https://github.com/vhanccos/morphe-patches/releases/tag/v1.39.3)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;135 patches total
<details>
...
| [Mono audio button](#mono-audio-button) | Adds an option to display a mono audio button in the video player overlay. |  |
